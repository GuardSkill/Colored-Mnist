...
def get_dataset(args):
    if args.dataset == 'mnist':
        ...
        trans = transforms.Compose(trans)
        fulltrainset = torchvision.datasets.SVHN(args.data, split='train', transform=trans, target_transform=None,
                                                 download=True)
        ...
        test_set = torchvision.datasets.SVHN(args.data, split='test', transform=trans, target_transform=None,
                                             download=True)
        testloader = torch.utils.data.DataLoader(test_set, batch_size=args.bs, shuffle=False, num_workers=NUM_WORKERS)
